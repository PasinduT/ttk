...
///
/// \ingroup vtk
/// \class ttkCombinatorialVectorField
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::CombinatorialVectorField module.
///
/// This VTK filter uses the ttk::CombinatorialVectorField module to compute an averaging of
...
///   - standalone/CombinatorialVectorField/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::CombinatorialVectorField
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkCombinatorialVectorFieldModule.h>
...
// TTK Base Includes
#include <CombinatorialVectorField.h>

class TTKCOMBINATORIALVECTORFIELD_EXPORT ttkCombinatorialVectorField
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::CombinatorialVectorField // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkCombinatorialVectorField *New();
  vtkTypeMacro(ttkCombinatorialVectorField, ttkAlgorithm);
...
protected:
   ...
   */
  ttkCombinatorialVectorField();
  ~ttkCombinatorialVectorField() override = default;
