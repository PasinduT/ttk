...
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::Testing module.
///
/// This VTK filter uses the ttk::Testing module to compute an averaging of
...
class TTKTESTING_EXPORT ttkTesting
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::Testing // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkTesting *New();
  vtkTypeMacro(ttkTesting, ttkAlgorithm);
