...
vtkStandardNewMacro(ttkTesting);
 ...
 */
int ttkTesting::FillInputPortInformation(int port, vtkInformation *info) {
  if(port == 0) {
 ...
 */
int ttkTesting::FillOutputPortInformation(int port, vtkInformation *info) {
  if(port == 0) {
 ...
 */
int ttkTesting::RequestData(vtkInformation *ttkNotUsed(request),
