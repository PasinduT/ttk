...
///
/// \ingroup base
/// \class ttk::CombinatorialVectorField
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// This module defines the %CombinatorialVectorField class that computes for each vertex of a
/// triangulation the average scalar value of itself and its direct neighbors.
///
/// \b Related \b publication: \n
/// 'CombinatorialVectorField'
...
namespace ttk {
  ...
  /**
   * The CombinatorialVectorField class provides methods to compute for each vertex of a
   * triangulation the average scalar value of itself and its direct neighbors.
   */
  class CombinatorialVectorField : virtual public Debug {
  ...
  public:
    ...
    int computeCVT(dataType *outputData,
...
#pragma omp parallel for num_threads(this->threadNumber_)
  ...
  }; // CombinatorialVectorField class
